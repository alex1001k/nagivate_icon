...
Sub ExportDashboards()
    ...
    Dim colDashNum As Long, colScreenNum As Long, colUrlNum As Long
...
NextRow:
    ...
    If errLog <> "" Then
        MsgBox "Done with " & errCount & " issue(s):" & vbCrLf & errLog, vbExclamation
    Else
        MsgBox "Done! Files saved to:" & vbCrLf & folderPath, vbInformation
    End If
End Sub
